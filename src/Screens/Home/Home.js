            ...
            <div className="container-fluid">
              ...
              <div className="row">
                ...
                <Switch>
                  ...
                  <Route path="/Home/expense" exact ><Expense /></Route>
                  <Route path="/Home/income" exact ><Income /></Route>
                  <Route path="/Home/contacts" exact ><Contacts/></Route>
                  ...
                  <Route path="/Home/doc" exact ><Documents isAuthenticated={isAuthenticated} userInfo={userInfo}/></Route>
  ...
  return (
    <div className="row" style={styleBox.header}>
      <div className="col s12 m8 l9"></div>
        <div className="col hide-on-small-only m2 l2" style={styleBox.name}>{data.userInfo.displayName}</div>
